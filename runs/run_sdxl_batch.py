...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Run runs/single/sdxl.py over prompts from a .txt or .json file.",
    )
    parser.add_argument("--prompts_file", type=Path, required=True, help="Path to .txt or .json prompts file.")
    parser.add_argument("--sdxl_script", type=Path, default=Path("runs/single/sdxl.py"), help="Path to the single-prompt SDXL script.")
